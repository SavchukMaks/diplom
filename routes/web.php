...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('/employee','EmployeeController@store')->name('employee.save');
    ...
    Route::get('/employees/{employee}/destroy','EmployeeController@destroy')->name('employee.destroy');
//    Route::get('/employees/{employee}/file', function(){
